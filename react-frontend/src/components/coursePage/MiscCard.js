...
export const MiscCard = ({miscs, value, headerColour}) => {
    ...
    const displayMisc = (field, header) => {
        ...
        if (miscsFiltered.length) {
            ...
            <div className="mt-3 mb-5">
                <h1 className="text-xl font-bold mb-5 text-red-700">{header}</h1>
        ...
        {(miscs && miscs.length > 0) ?
            <div>
                    <div className="flex flex-row justify-between mb-3">
                        <h1 className={`pl-3 pt-4 text-3xl font-bold pb-3 ${headerColour}`}>
                            Miscs:
                        </h1>
